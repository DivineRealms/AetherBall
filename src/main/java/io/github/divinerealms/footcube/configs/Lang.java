...
public enum Lang {
  ...
  MATCH_CLEAN_SHEET_BONUS("match.clean-sheet-bonus", "{prefix}&aYou got 30 credits for having a clean sheet"),
  ...
  HELP_HEADER("help.header", "&e-------------[ &6&lFootCube Help &e]----------------"),
  ...
  HELP_CATEGORIZED("help.categorized", String.join(System.lineSeparator(),
      "&e-------------[ &6&lFootCube Help &e]----------------",
      "&r &r",
      "&a                 &lGlavna stranica pomoćnika.",
      "&r &r",
      ...
      "&r &r",
      "&7        &oKucajte &e/fc help &a<kategorija> &7&oza više info.",
      "&e---------------------------------------------"
  )),
  ...
  HELP_CATEGORY_3("help.category.3", String.join(System.lineSeparator(),
      "&r &r",
      "&a                   &lKomande za podešavanja!",
      "&r &r",
      "&6  ▪ &b&lToggles:",
      "&e  /fct &6or &e/fc toggle kick&7: &f&oToggle kick sound effects.",
      "&e  /fct &6or &e/fc toggle goal&7: &f&oToggle goal sound effects.",
      "&e  /fct &6or &e/fc toggle particles&7: &f&oToggle particles.",
      "&e  /fct&6or &efc toggle hits&7: &f&oToggle hit visualization.",
      "&r &r",
      "&6  ▪ &b&lCustomization:",
      "&e  /fcss&6or &efc setsound kick &a<sound>&7: &f&oSet kick sound.",
      "&e  /fcss&6or &efc setsound goal &a<sound>&7: &f&oSet goal sound.",
      "&e  /fcsp&6or &efc setparticle &a<type> &3[color]&7: &f&oSet trail.",
      "&e  /fcsgc&6or &efc setgoalcelebration &a<style>&7: &f&oSet goal style.",
      "&r &r",
      "&7     &oKoristite &alist &7&okao argument da vidite sve opcije."
  )),
  HELP_CATEGORY_4("help.category.4", String.join(System.lineSeparator(),
      ...
      "&e  /clearcube &6or &efc clearcube&7: &f&oClear nearest cube.",
      "&e  /clearcubes &6or &efc clearcubes&7: &f&oClear all cubes.",
      "&e  /stats &6or &efc stats&7: &f&oView player statistics.",
      "&e  /highscores &6or &ebest &6or &efc highscores &6or &efc best",
      "&e  /build&7: &f&oActivate build mode.",
      "&r &r"
  )),
  HELP_CATEGORY_UNKNOWN("help.category.unknown", String.join(System.lineSeparator(),
      "&c                      &lNepoznata kategorija!",
      "&r &r",
      "&f                    Lista dostupnih kategorija:",
      "&e                 gameplay, teams, settings, utility",
      "&r &r",
      " &7            &oKoristite &e/fc help|h &7za sve kategorije."
  )),
