...
public class LoggerUtil {
  ...
  public static void sendMessage(
      String permission, Location center, double radius, Object messageObject, String... args) {
  ...
  public static void sendActionBar(Player player, Object messageObj, String... args) {
    ...
    IChatBaseComponent iChatBaseComponent =
        ChatSerializer.a("{\"text\":\"" + escapeJson(message) + "\"}");
  ...
  public static void title(
      Player player, Object titleObj, Object subtitleObj, int fadeIn, int stay, int fadeOut) {
    if (!isPlayerOnline(player)) {
      return;
    }
    ...
    IChatBaseComponent subtitleJSON =
        ChatSerializer.a("{\"text\":\"" + escapeJson(subtitle) + "\"}");

    craftPlayer
        .getHandle()
        .playerConnection
        .sendPacket(new PacketPlayOutTitle(EnumTitleAction.TITLE, titleJSON));
    craftPlayer
        .getHandle()
        .playerConnection
        .sendPacket(new PacketPlayOutTitle(EnumTitleAction.SUBTITLE, subtitleJSON));
    craftPlayer
        .getHandle()
        .playerConnection
        .sendPacket(new PacketPlayOutTitle(fadeIn, stay, fadeOut));
  }
  ...
  private static String resolveMessage(Object messageObject, boolean forConsole, String... args) {
    ...
    if (forConsole && !message.startsWith("{prefix_")) {
