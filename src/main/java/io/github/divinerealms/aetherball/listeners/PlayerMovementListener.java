 ...
 * <p>
 * Records player velocity data used to calculate kick power and impact force when interacting with
 * cubes. Filters out players in AFK or restricted states.
 * </p>
 */
public class PlayerMovementListener extends BaseListener {
   ...
   * <p>
   * Calculates instantaneous velocity from position delta and stores it for physics calculations.
   * Movement is scaled vertically to account for player height differences.
   * </p>
   *
