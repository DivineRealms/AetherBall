 ...
 * <p>
 * Removes all Slime entities from unloading chunks to prevent ghost cubes and memory issues when
 * chunks reload later.
 * </p>
 */
public class ChunkCheckers extends BaseListener {
   ...
   * <p>
   * Iterates through entities in the unloading chunk and kills any Slime instances to ensure proper
   * cleanup and prevent entity persistence issues.
   * </p>
   *
