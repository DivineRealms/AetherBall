 ...
 *
 * <p>Provides a lighter form of cube interaction compared to kicks, applying vertical boosts with
...
public class CubeTapListener extends BaseListener {
   ...
   * Handles right-click interactions with cube entities.
   *
   * <p>Applies a vertical boost to tracked cubes when right-clicked, with per-cube cooldown
   * tracking to prevent spam. This provides a softer interaction method compared to kicks.
   *
