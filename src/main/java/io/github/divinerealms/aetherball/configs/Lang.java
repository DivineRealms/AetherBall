...
public enum Lang {
  ...
  NO_PERM_PARAMETERS(
      "no-perm.parameters", "{prefix_error}You don't have permission for command &6/&e{1}&c!"),
  ...
  HITDEBUG_PLAYER_CHARGED(
      "debug.hits-player.charged", "&8[&dCharged&8] &a{0}KP &8[&e&o{1}PW&8, &d&o{2}CH&8]"),
  ...
  HITDEBUG_CHARGED("debug.hits.charged", "&dCharged &8| {0} &8| {1}KP &8| &e{2}PW&7, &d{3}CH"),
  HITDEBUG_REGULAR("debug.hits.regular", "&aRegular &8| {0} &8| &a{1}KP"),
  HITDEBUG_VELOCITY_CAP(
      "debug.hits.velocity-cap",
  ...
  TEAM_ACCEPT_OTHER(
      ...
      String.join(
          System.lineSeparator(),
          "{prefix_success}You successfully teamed with {0}",
  ...
  TEAM_DECLINE_SELF(
      "team.decline.self", "{prefix_success}You successfully declined the team request"),
  ...
  TEAM_WANTS_TO_TEAM_OTHER(
      "team.wants-to-team.other",
      String.join(
          System.lineSeparator(),
  ...
  TEAM_WANTS_TO_TEAM_SELF(
      "team.wants-to-team.self",
      String.join(
          System.lineSeparator(),
  ...
  TAKEPLACE_SUCCESS(
      "takeplace.success", "{prefix_success}&b[Coach] You've taken a spot in match #{0}"),
  ...
  TAKEPLACE_AVAILABLE_HEADER(
      "takeplace.available.header", "{prefix_info}Available matches to join:"),
  TAKEPLACE_AVAILABLE_ENTRY(
      "takeplace.available.entry", "{prefix_info}&e- Match #{0} &7({1}) - &a{2} &7slots open"),
  TAKEPLACE_INVALID_ID(
      "takeplace.invalid-id", "{prefix_error}Could not find an open match with ID #{0}."),
  ...
  DUEL_NO_PENDING_REQUEST(
      "duel.no-pending-request", "{prefix_error}You don't have any pending duel requests."),
  DUEL_NO_OUTGOING_REQUEST(
      "duel.no-outgoing-request", "{prefix_error}You don't have any outgoing duel requests."),
  DUEL_SENDER_OFFLINE(
      "duel.sender-offline",
  ...
  DUEL_ACCEPTED_ACCEPTOR(
      "duel.accepted-acceptor", "{prefix_success}You accepted &b{0}'s &fduel request!"),
  DUEL_ACCEPTED_SENDER(
      "duel.accepted-sender", "{prefix_success}&b{0} &faccepted your duel request!"),
  DUEL_DECLINED_DECLINER(
      "duel.declined-decliner", "{prefix_success}You declined the duel request."),
  ...
  STATS(
      ...
      String.join(
          ...
          "&7 Assists: &b{9}",
          "&7 Skill level: &a{10} &7| Rank: &f{11}",
          "&7 Own goals: &c{12}",
          "&r &r",
  ...
  STATSSET_NOT_A_STAT(
      "stats-set.not-a-stat",
      String.join(
          System.lineSeparator(),
          "{prefix_error}{0} is not a stat, choose from:",
  ...
  SETUP_ARENA_START(
      ...
      String.join(
          System.lineSeparator(),
          "{prefix_info}You just started setting up an arena",
  ...
  SETUP_ARENA_FIRST_SET(
      "setup-arena.first-set",
      String.join(
          System.lineSeparator(),
          "{prefix_success}First location successfully set.",
  ...
  CLEAR_ARENAS_TYPE_SUCCESS(
      "clear-arenas.type-success", "{prefix_success}Successfully cleared &e{0} &farenas!"),
  ...
  TAKE_PLACE_ANNOUNCEMENT_LOBBY(
      "match.tkp-announcement.lobby",
      "{prefix_info}&6&lSUBSTITUTION: &fSomeone left {0}&f during the discussion phase."),
  TAKE_PLACE_ANNOUNCEMENT_MATCH(
      "match.tkp-announcement.match",
      String.join(
          System.lineSeparator(),
  ...
  COMMAND_DISABLER_ALREADY_ADDED(
      "command-disabler.already-added", "{prefix_error}This command was already added"),
  COMMAND_DISABLER_SUCCESS(
      "command-disabler.added-successfully",
      "{prefix_success}You successfully added command &e/{0} &fto the list of disabled commands"),
  COMMAND_DISABLER_SUCCESS_REMOVE(
      "command-disabler.removed-successfully",
      "{prefix_success}You successfully removed command &e/{0} &ffrom the list of disabled commands"),
  COMMAND_DISABLER_WASNT_ADDED(
      "command-disabler.wasnt-added", "{prefix_error}This command wasn't even added"),
  COMMAND_DISABLER_LIST("command-disabler.list", "{prefix_info}List of disabled commands:"),
  COMMAND_DISABLER_CANT_USE(
      "command-disabler.cant-use", "{prefix_error}You cannot use this command during a match"),
  ...
  MATCH_WINSTREAK_CREDITS(
      "match.winstreak-credits",
  ...
  MATCH_CLEAN_SHEET_BONUS(
      "match.clean-sheet-bonus", "{prefix_other}You got 30 credits for a clean sheet"),
  MATCH_ASSIST_CREDITS("match.assist-credits", "{prefix_other}You got 5 credits for an assist"),
  MATCH_SCORE_HATTRICK(
      "match.score-hattrick", "{prefix_other}&6&lYou get 100 credits bonus for a hat-trick"),
  ...
  MATCH_SCORE_STATS(
      ...
      String.join(
          System.lineSeparator(),
          "&aIt is now {0}-{1} Red-Blue",
          "{prefix_other}The match will continue in 10 seconds")),
  MATCH_SCORE_OWN_GOAL_ANNOUNCE(
      "match.score-own-goal-announce", "&6&lOWN GOAL! &a{0} scored a goal for the opposing team"),
  MATCH_PREVENT_ABUSE(
      "match.prevent-abuse", "{prefix_error}Command abuse is prohibited during the match."),
  ...
  BEST_HEADER(
      "best.header",
      String.join(System.lineSeparator(), "&6All AetherBall highscores:", "&bBest ratings:")),
  ...
  BEST_UPDATING(
      "best.updating", "&cHighscores are not yet available. Try again in a few seconds..."),
  ...
  SCOREBOARD_LINES_LOBBY(
      "scoreboard.lines.lobby",
      String.join(
          System.lineSeparator(),
          "&r &r",
          "&r &r",
  ...
  SCOREBOARD_LINES_MATCH(
      "scoreboard.lines.match",
      String.join(
          System.lineSeparator(),
          "&r &r",
          "{0}",
  ...
  PRACTICE_AREAS_EMPTY(
      "practice-areas-empty", "{prefix_error}No practice zones defined. Not clearing cubes."),

  CLEARED_CUBES("cleared-cubes", "&bℹ Cleared &e{0} cube(s) &ffrom practice zones &bℹ"),
  CLEARED_CUBE_INGAME(
      "cleared-cube-ingame", "{prefix_other}Cube was cleared during the match! Respawning it."),

  PRACTICE_AREA_SET(
      "practice-area-set",
      "{prefix_success}Successfully set practice zone &b{0}&f (&o{1}, {2}, {3}&f)."),

  FC_DISABLED("fc-disabled", "{prefix_error}Joining matches is temporarily disabled by an admin."),
  ...
  TOGGLES_PARTICLES_MODE(
      "toggles.particles-mode", "{prefix_success}Particle trail mode set to: &a{0}"),
  ...
  SET_PARTICLE_REDSTONE(
      "set.particle.redstone", "{prefix_success}Particle set to &e{0} &fwith color {1}"),
  ...
  SET_GOAL_CELEBRATION(
      "set.goal-celebration", "{prefix_success}You set your goal celebration style to: &e{0}"),
  ...
  SET_BLOCK_TOO_FAR(
      "set.block.too-far", "{prefix_error}You must be looking at a block within 5 blocks of you."),
  SET_BLOCK_SUCCESS("set.block.success", "{prefix_success}Successfully set &e{0} &fbutton!"),

  BLOCK_INTERACT_COOLDOWN(
      "block-interact-cooldown", "{prefix_error}Wait &e{0} &cbefore using this again."),

  MATCHES_LIST_NO_MATCHES(
      "matches.list.no-matches", "{prefix_error}There are currently no active matches..."),
  ...
  TASKS_REPORT_HEADER(
      "plugin-stats.report.tasks.header",
      String.join(
          System.lineSeparator(),
          "&e-------------[ &6&lTask Status &e]----------------",
          "&r &r",
  ...
  TASKS_REPORT_FOOTER(
      "plugin-stats.report.tasks.footer",
      String.join(
          System.lineSeparator(),
          "&r &r",
          ...
          "&e---------------------------------------------")),
  TASKS_RESTART(
      "plugin-stats.report.tasks.restart", "{prefix_success}All tasks have been restarted."),
  TASKS_RESET_STATS(
      "plugin-stats.report.tasks.reset-stats",
   ...
   *
   * <p>Should be called automatically when language configuration changes via setFile().
   */
   ...
   *
   * <p>Automatically handles {prefix_type} placeholders using player-friendly colored prefixes. For
